...
//            if ($(".swiper-slider-clients").length > 0) swiperClients.onResize();
    ...
    var $Quickdiv = '<div class="all-demo alt-font sm-display-none popup-with-zoom-anim wow fadeInUp"><a href="/start-your-project"><i class="fa fa-whatsapp"></i><span>Quick Question?</span></a></div>';
