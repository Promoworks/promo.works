...
//            if ($(".swiper-demo-header-style").length > 0) swiperDemoHeaderStyle.onResize();
    ...
    // var $Quickdiv = '<div class="all-demo alt-font sm-display-none popup-with-zoom-anim wow fadeInUp"><a href="/start-your-project"><i class="ti-email"></i><span>Quick Question?</span></a></div>';
    var $SecondQuickdiv = '<div class="all-whats alt-font hidden-md hidden-lg visible-xs popup-with-zoom-anim wow fadeInUp"><a href="https://api.whatsapp.com/send?phone=919488889989&text=I%20WOULD%20LIKE%20TO%20ENQUIRE%20ABOUT FILM%20POST-PRODUCTION%20SOLUTIONS"><i class="fa fa-whatsapp fa-2x"></i><span>Quick Whatsapp</span></a></div>';
//    var $Worksdiv = '<div class="all-works alt-font popup-with-zoom-anim wow fadeInUp visible-xs visible-lg visible-md visible-sm"><a href="/works" title="Works" rel="noopener" itemprop="Works"><i class="ti-harddrives"></i><span>Work</span></a></div>';

    // $('body').append($Quickdiv);
    $('body').append($SecondQuickdiv);
//    $('body').append($Worksdiv);
